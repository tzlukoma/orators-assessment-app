    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Switch>
          ...
          <PublicRoute {...props} restricted={true} path={ROUTES.SIGN_UP} component={SignUp}/>
          <PublicRoute {...props} restricted={true} path={ROUTES.COACH_SIGNUP} component={CoachSignUp}/>
          ...
          <PrivateRoute {...props} path={`${ROUTES.ADD_ORATOR}/:chapter_id/:family_id`} component={AddOrator}/>
