    ...
    <BrowserRouter>
      <div className="App">
        ...
        <Switch>
          ...
          <Route path={`${ROUTES.ASSESSMENT}/:id`} component={AssessmentDetails} />
          <Route path={`${ROUTES.ORATOR}/:id`} component={OratorDetails} />
          <Route path={`${ROUTES.CREATE_ASSESSMENT}/:id/:firstname/:lastname`} component={CreateAssessment} />
          <Route path={`${ROUTES.ADD_ORATOR}/:chapter_id/:family_id`} component={AddOrator} />
